...
function calcAverageCalories(days) {
  ...
  let totalCalories = 0;
  // Iterate over the 'days' array and access the 'calories' property of each object
  for (const day of days) {
    totalCalories += day.calories; // Access 'calories' property of each day object
  }
  // Return the average calories, using the actual number of days
